...
//         try {
//             const response = await fetch("http://localhost:8081/chat/createGroup", {
//                 method: "POST",
//                 headers: {
...
//     // Example usage
//     createGroup("Study Group", ["userId1", "userId2", "userId3"]);
...
//     //                                 onClick={async () => {
//     //                                     // Pass the states to the createGroup function
...
//                 {/* Sidebar */}
//                 <div className="w-full md:w-1/4 bg-gray-200 p-4 shadow-lg border-r border-gray-600 overflow-y-auto h-full">
//                     <div className="flex justify-between items-center mb-6">
//                         <h2 className="text-xl font-semibold">Groups</h2>
//                         <button
//                             onClick={() => setShowCreateGroupModal(true)}
...
//                                                 Group Info
//                                             </li>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Select Messages</li>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Add to Favorites</li>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Clear Chat</li>
//                                         </ul>
//                                     </div>
//                                 )}
//                             </div>
...
//                                         >
//                                             <p>{msg.text}</p>
//                                             <span className="text-sm text-gray-500 ml-1">{msg.time}</span>
//                                         </div>
//                                     </div>
//                                 ))}
//                             </div>
...
//                                     <div className="absolute bottom-14 left-4 bg-white shadow-lg rounded-lg border p-2">
//                                         <ul>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Document</li>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Photo</li>
//                                             <li className="p-2 hover:bg-gray-100 cursor-pointer">Video</li>
    ...
    const createGroup = async (groupName, memberIds) => {
        ...
        try {
            ...
            if (response.ok) {
                const data = await response.json();
                console.log("Group created successfully:", data);
                setGroups((prevGroups) => [...prevGroups, data]); // Add the new group to the state
                return data;
            } else {
                console.error("Failed to create group. Status:", response.status);
            }
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-100">
            ...
            <div className="flex flex-1 h-full flex-col md:flex-row">
                ...
                <div className="hidden md:block w-1/4 bg-gray-200 p-4 shadow-lg border-r border-gray-600 overflow-y-auto h-full">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-xl font-semibold">Groups</h2>
                        <button
                            onClick={() => setShowCreateGroupModal(true)}
                ...
                {/* Chat Window */}
                <div className={`flex-1 flex flex-col relative overflow-hidden p-2 ${selectedGroup ? 'h-full' : 'h-auto'}`}>
                    {selectedGroup ? (
                        <>
                            {/* Group Navbar */}
                            <div className="p-2 border-b bg-gray-200 flex items-center justify-between shadow-sm md:hidden">
                                <div className="flex items-center">
                                    <div className="w-10 h-10 rounded-full bg-gray-400 flex items-center justify-center mr-3">
                                        G
                                    </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-full">
                            <h2 className="text-2xl font-semibold text-gray-600">Select a group to start chatting</h2>
                        </div>
                    )}
                </div>
            </div>
