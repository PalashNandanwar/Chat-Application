...
//     //                 {selectedGroup ? (
//     //                     <ChatWindow group={selectedGroup} userData={userData} />
//     //                 ) : (
...
//                         <button
//                             onClick={() => setShowCreateGroupModal(true)}
//                             className="bg-blue-500 text-white p-2 rounded-full hover:bg-blue-600 text-sm"
//                         >
//                             + Create Group
//                         </button>
//                     </div>
...
//                         <button
//                             className="bg-blue-500 text-white p-2 rounded-full hover:bg-blue-600 w-full text-sm"
//                             onClick={createGroup}
//                         >
//                             Create Group
//                         </button>
//                         <button
//                             className="bg-gray-500 text-white p-2 rounded-full hover:bg-gray-600 w-full mt-2 text-sm"
